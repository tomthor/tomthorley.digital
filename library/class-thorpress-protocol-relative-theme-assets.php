 ...
 *
 * @package ThorPress
 * @since ThorPress 1.1.0
 */

if ( ! class_exists( 'Thorpress_Protocol_Relative_Theme_Assets' ) ) :
	class Thorpress_Protocol_Relative_Theme_Assets {
		/**
	...
	$thorpress_protocol_relative_theme_assets = new Thorpress_Protocol_Relative_Theme_Assets;
endif;
