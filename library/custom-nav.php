	...
	function wpt_register_theme_customizer( $wp_customize ) {
		...
		$wp_customize->add_panel(
			'mobile_menu_settings', array(
				'priority'       => 1000,
				'theme_supports' => '',
				'title'          => __( 'Mobile Menu Settings', 'thorpress' ),
				'description'    => __( 'Controls the mobile menu', 'thorpress' ),
			)
		);
		...
		$wp_customize->add_section(
			'mobile_menu_layout', array(
				'title'    => __( 'Mobile navigation layout', 'thorpress' ),
		...
		$wp_customize->add_control(
			...
			// Add logo options
			$wp_customize->add_section( 'thorpress_logo_section' , array(
				'title'       => __( 'Logo', 'themeslug' ),
				'priority'    => 30,
				'description' => 'Upload a logo to replace the default site name and description in the header',
			) );

			$wp_customize->add_setting( 'thorpress_logo' );

			$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'thorpress_logo', array(
				'label'    => __( 'Logo', 'thorpress' ),
				'section'  => 'thorpress_logo_section',
				'settings' => 'thorpress_logo',
			) ) );
